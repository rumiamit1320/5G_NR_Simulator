...
object NrCsiV80 {
    fun report(ueId:Int,sinrDb:Double,rank:Int=1,pmi:Int=0):NrCsiReportV80{
        val cqi=when{sinrDb< -5->0;sinrDb< -2->1;sinrDb<0->2;sinrDb<2->3;sinrDb<4->4;sinrDb<6->5;sinrDb<8->6;sinrDb<10->7;sinrDb<12->8;sinrDb<14->9;sinrDb<16->10;sinrDb<18->11;sinrDb<20->12;sinrDb<22->13;sinrDb<24->14;else->15};return NrCsiReportV80(ueId,cqi.coerceAtLeast(1).coerceAtMost(rank.coerceAtLeast(1)),sinrDb, cqi,rank.coerceAtLeast(1),pmi)
    }
