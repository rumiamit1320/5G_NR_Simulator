...
object NrRadioEnvironmentV62Tests {
    ...
    fun run(): Result {
        val a = NrRadioEnvironmentV62.run(NrRadioEnvironmentConfigV62(ueCount = 8, cells = 1, prbs = 52, velocityKmh = 0.0, slotIndex = 0))
        val b = NrRadioEnvironmentV62.run(NrRadioEnvironmentConfigV62(ueCount = 8, cells = 3, prbs = 52, velocityKmh = 60.0, slotIndex = 0))
        val moving = NrRadioEnvironmentV62.run(NrRadioEnvironmentConfigV62(ueCount = 8, cells = 1, prbs = 52, velocityKmh = 60.0, slotIndex = 10))
        val checks = listOf(
            ...
            "Mobility changes geometry" to (moving.ueStates.first().xM != a.ueStates.first().xM || moving.ueStates.first().yM != a.ueStates.first().yM),
