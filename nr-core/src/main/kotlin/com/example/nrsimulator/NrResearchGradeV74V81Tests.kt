...
/** Lightweight deterministic regression gate for the additive V74-V81 layer. */
object NrResearchGradeV74V81Tests {
    ...
    fun run():Result {
        ...
        val h=arrayOf(intArrayOf(1,1,0,1),intArrayOf(0,1,1,1));val d=NrLdpcV74.decode(doubleArrayOf(4.0,4.0,-4.0,4.0),h)
        ck("V74 decoder finite",d.bits.size==4 && d.syndromeWeight>=0)
        ...
        val csi=NrCsiV80.report(1,12.0);ck("V80 CSI",csi.cqi in 0..15&&csi.widebandSinrDb==12.0)
