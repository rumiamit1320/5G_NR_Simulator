...
fun main() {
    ...
    runCatching {
        val r = NrIntegratedNetworkV66.run(
            NrIntegratedNetworkConfigV66(slots = 3, ueCount = 4, cells = 2, prbs = 24, scsKHz = 30, seed = 6607)
        )
    ...
    runCatching {
        val timed = NrTimingV67.run(
            NrIntegratedNetworkConfigV66(slots = 8, ueCount = 4, cells = 2, prbs = 24, scsKHz = 30, seed = 6901)
        )
    ...
    runCatching {
        val r = NrHarqExecutionV70.run(
            NrIntegratedNetworkConfigV66(slots = 8, ueCount = 4, cells = 2, prbs = 24, scsKHz = 30, seed = 7001),
            NrHarqExecutionConfigV70(extraSlotsForRetransmissions = 16)
        )
