...
function loadMimoViz(){if(document.querySelector('script[data-v64-mimo-viz]'))return;const s=document.createElement('script');s.src='/radio-v64-mimo-plots.js';s.dataset.v64MimoViz='1';s.defer=false;document.body.appendChild(s)}
function start(){loadMimoViz();let n=0;const t=setInterval(()=>{if(ensure()){clearInterval(t);observe()}if(++n>100)clearInterval(t)},100)}
start();
})();
